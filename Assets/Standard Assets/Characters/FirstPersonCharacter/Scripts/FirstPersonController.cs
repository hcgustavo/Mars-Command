...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        [SerializeField] private AudioClip m_ShotFiredSound;
        ...
        private void Start()
        {
            ...
            m_AudioSource = m_AudioSources[0];
            m_AudioSource2 = m_AudioSources[1];
        ...
        private void PlayShotFiredSound()
        {
            m_AudioSource2.clip = m_ShotFiredSound;
            m_AudioSource2.Play();
        }
        ...
        private void Shoot()
        {
            ...
            {
                if (hit.collider.gameObject.tag == "Enemy" || hit.collider.gameObject.tag == "Turret")
                {
                    //Hit Enemy
                    hit.collider.gameObject.SendMessage("TakeHit", hitAmount);
                }
            }
        }
        ...
        {
            if(other.gameObject.tag == "Krystal")
            {
                collectedCrystals++;
            ...
            else if(other.gameObject.name == "Spaceship")
            {
                if(collectedCrystals == 5)
                {
                    gameCompleted = true;
                    Time.timeScale = 0f;
                    GameObject.Find("UIController").SendMessage("ShowGameCompletedPanel");
                }
            }
        }
